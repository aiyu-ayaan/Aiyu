...
export default async function ContactPage() {
    ...
    // Social links removed from grid as per user request
    const socials = [];
    ...
    return (
        <div className="min-h-screen py-20 px-4 md:px-8 bg-[var(--bg-primary)] text-[var(--text-primary)] transition-colors duration-300">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 grid-rows-[auto]">
                    ...
                    {/* 2. Status Card */}
                    <div className="md:col-span-1 bg-green-50 dark:bg-green-900/10 rounded-3xl p-6 flex flex-col justify-between border border-green-100 dark:border-green-800/30">
                    ...
                    {/* 3. Location Card */}
                    <div className="md:col-span-1 bg-blue-50 dark:bg-blue-900/10 rounded-3xl p-6 flex flex-col justify-between border border-blue-100 dark:border-blue-800/30">
