                                                ...
                                                {expandedLogId === log._id && (
                                                    <tr>
                                                        <td colSpan={7} className="bg-slate-950/70 px-4 py-4">
                                                            <pre className="max-h-[520px] overflow-auto whitespace-pre-wrap rounded-2xl border border-white/10 bg-slate-950 p-4 font-mono text-xs leading-relaxed text-cyan-300 custom-scrollbar">
