                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                        <div>
                            ...
                            <div className="space-y-3">
                                {[
                                    { id: 'gemini-3-flash-preview', name: 'Gemini 3 Flash (Preview)', desc: 'Next-gen, hyper-fast performance.' },
                                    { id: 'gemini-2.0-flash', name: 'Gemini 2.0 Flash', desc: 'Fast, efficient, low latency.' },
                                    { id: 'gemini-2.0-flash-exp', name: 'Gemini 2.0 Flash Exp', desc: 'Experimental features.' },
