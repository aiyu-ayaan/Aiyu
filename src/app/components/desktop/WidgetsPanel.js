...
export default function WidgetsPanel({ open, onClose, openApp }) {
    ...
    return (
        <>
            {/* Backdrop */}
            <div
                className={`fixed inset-0 z-40 bg-black/20 backdrop-blur-[2px] transition-opacity duration-250 ${
            ...
            {/* Panel */}
            <div
                className={`fixed bottom-12 left-0 top-0 z-50 flex w-full max-w-[440px] flex-col border-r border-white/10 bg-[#161618]/92 text-white shadow-2xl shadow-black/40 backdrop-blur-2xl transition-all duration-250 ease-out ${
