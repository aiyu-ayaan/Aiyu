...
const Divider = () => {
  ...
  const accentCyan = getColor('--accent-cyan');
  const accentPurple = getColor('--accent-purple');
  const accentPink = getColor('--accent-pink');
