        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-[#0a0a0a]/60 backdrop-blur-xl rounded-2xl border border-white/5 p-8 relative overflow-hidden group">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                            <div>
                                <label className="block text-xs font-mono uppercase tracking-wider text-slate-500 mb-2">Project Designation</label>
                                <div className="relative group/input">
                                    <Terminal className="absolute left-4 top-3.5 text-slate-500 group-focus-within/input:text-cyan-400 transition-colors" size={18} />
                                    <input
                                        type="text"
                                        name="name"
                                        value={formData.name}
                            ...
                            <div>
                                <label className="block text-xs font-mono uppercase tracking-wider text-slate-500 mb-2">Timeline / Year</label>
                                <div className="relative group/input">
                                    <Calendar className="absolute left-4 top-3.5 text-slate-500 group-focus-within/input:text-cyan-400 transition-colors" size={18} />
                                    <input
                                        type="text"
                                        name="year"
                                        value={formData.year}
                        ...
                        <div className="mt-6 relative z-10">
                            <label className="block text-xs font-mono uppercase tracking-wider text-slate-500 mb-2">Description Payload</label>
                            <div className="relative group/input">
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    rows="4"
                                    className="w-full bg-black/40 border border-white/10 rounded-xl py-3 pl-12 pr-4 text-slate-300 focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50 outline-none transition-all placeholder:text-slate-700 leading-relaxed text-sm resize-none"
                                    required
                    ...
                    <div className="bg-[#0a0a0a]/60 backdrop-blur-xl rounded-2xl border border-white/5 p-8 relative overflow-hidden group">
                        ...
                        <h2 className="text-sm font-mono text-purple-500/70 uppercase tracking-widest mb-8 flex items-center gap-4 relative z-10">
                        ...
                        <div className="space-y-6 relative z-10">
                            <div>
                                <label className="block text-xs font-mono uppercase tracking-wider text-slate-500 mb-2">Tech Stack (Comma Separated)</label>
                                <div className="relative group/input">
                                    <Code className="absolute left-4 top-3.5 text-slate-500 group-focus-within/input:text-purple-400 transition-colors" size={18} />
                                    <input
                                        type="text"
                                        name="techStack"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-xs font-mono uppercase tracking-wider text-slate-500 mb-2">Project Category</label>
                                    <div className="relative group/input">
                                        <Layers className="absolute left-4 top-3.5 text-slate-500 group-focus-within/input:text-purple-400 transition-colors" size={18} />
                                        <input
                                            type="text"
                                            name="projectType"
                                            value={formData.projectType}
                                            onChange={handleChange}
                                            className="w-full bg-black/40 border border-white/10 rounded-xl py-3 pl-12 pr-4 text-slate-200 focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 outline-none transition-all placeholder:text-slate-700"
                                            required
                                ...
                                <div>
                                    <label className="block text-xs font-mono uppercase tracking-wider text-slate-500 mb-2">Repo / Live Link</label>
                                    <div className="relative group/input">
                                        <LinkIcon className="absolute left-4 top-3.5 text-slate-500 group-focus-within/input:text-purple-400 transition-colors" size={18} />
                                        <input
                                            type="url"
                                            name="codeLink"
                ...
                <div className="space-y-8">
                    {/* Status Module */}
                    <div className="bg-[#0a0a0a]/60 backdrop-blur-xl rounded-2xl border border-white/5 p-6 relative overflow-hidden group">
                        ...
                        <h2 className="text-sm font-mono text-emerald-500/70 uppercase tracking-widest mb-6 relative z-10">Development Status</h2>
                        <div className="relative z-10 bg-black/40 p-2 rounded-xl border border-white/10">
                            <select
                                name="status"
                            ...
                            >
                                <option value="Done" className="bg-gray-900 text-slate-200">Done (Completed)</option>
                                <option value="In Progress" className="bg-gray-900 text-slate-200">In Progress (Active)</option>
                            </select>
                        </div>
                    ...
                    {/* Image Module */}
                    <div className="bg-[#0a0a0a]/60 backdrop-blur-xl rounded-2xl border border-white/5 p-6 relative overflow-hidden group">
                        <h2 className="text-sm font-mono text-slate-500 uppercase tracking-widest mb-6">Visual Asset</h2>
                        <div className="relative group/input mb-4">
                            <ImageIcon className="absolute left-4 top-3.5 text-slate-500 group-focus-within/input:text-white transition-colors" size={18} />
                            <input
                                type="text"
                                name="image"
                                value={formData.image}
                                onChange={handleChange}
                                className="w-full bg-black/40 border border-white/10 rounded-xl py-3 pl-12 pr-4 text-slate-200 focus:border-white/30 focus:ring-1 focus:ring-white/10 outline-none transition-all placeholder:text-slate-700 font-mono text-xs"
                                placeholder="IMAGE_URL"
                            />
                        </div>
                        <div className="aspect-video w-full rounded-lg bg-black/40 border border-white/10 flex items-center justify-center overflow-hidden relative group/preview">
                            {formData.image ? (
            ...
            {/* Action Footer */}
            <div className="sticky bottom-8 bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-2xl flex justify-between items-center z-50">
                <div className="text-xs font-mono text-slate-500 px-4 flex items-center gap-2">
